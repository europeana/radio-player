...
var Amplitude = (function () {
    ...
    function privateDisplaySongMetadata(){
        ...
        /*
         Sets all elements that will contain the active song's license
         */
        if( document.querySelectorAll('[amplitude-song-info="license"]') ){
            var metaArtist = document.querySelectorAll('[amplitude-song-info="license"]');
            for( i = 0; i < metaArtist.length; i++ ){
                metaArtist[i].innerHTML = config.active_metadata.license;
            }
        }
